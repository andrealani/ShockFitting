...
#ifndef ShockFitting_ComputeStateDpsAr_hh
#define ShockFitting_ComputeStateDpsAr_hh
...
/// This class defines a ComputeStateDpsAr, whose task is to update 
...
class ComputeStateDpsAr : public ComputeStateDps {
public:

  /// Constructor
  /// @param objectName the concrete class name
  ComputeStateDpsAr(const std::string& objectName);
...
#endif // ShockFitting_ComputeStateDpsAr_hh

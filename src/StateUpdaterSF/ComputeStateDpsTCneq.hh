...
#ifndef ShockFitting_ComputeStateDpsTCneq_hh
#define ShockFitting_ComputeStateDpsTCneq_hh
...
/// This class defines a ComputeStateDpsPg, whose task is to update
...
class ComputeStateDpsTCneq : public ComputeStateDps {
public:

  /// Constructor
  /// @param objectName the concrete class name
  ComputeStateDpsTCneq(const std::string& objectName);

  /// Destructor
  ~ComputeStateDpsTCneq();
...
#endif // ShockFitting_ComputeStateDpsTCneq_hh

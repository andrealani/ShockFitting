...
#ifndef ShockFitting_ComputeStateDpsPg_hh
#define ShockFitting_ComputeStateDpsPg_hh
...
class ComputeStateDpsPg : public ComputeStateDps {
public:

  /// Constructor
  /// @param objectName the concrete class name
  ComputeStateDpsPg(const std::string& objectName);
...
#endif // ShockFitting_ComputeStateDpsPg_hh

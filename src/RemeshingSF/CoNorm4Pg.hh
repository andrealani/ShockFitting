...
#ifndef ShockFitting_CoNorm4Pg_hh
#define ShockFitting_CoNorm4Pg_hh
...
/// This class defines a CoNorm4Pg, whose task is to compute the normal unit
...
public:
  ...
  CoNorm4Pg(const std::string& objectName);

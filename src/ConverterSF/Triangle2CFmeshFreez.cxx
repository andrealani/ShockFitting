...
void Triangle2CFmeshFreez::convert()
{
  ...
  LogToScreen(DEBUG_MIN, "Triangle2CFmeshFreez::storing CFmesh data\n");
  storeCFmeshData();
...
//      fprintf(fileFarFieldBC,"%s","VARIABLES  =  \"s\" ");
      ...
      fprintf(fileFarFieldBC,"%6u %s", elemVector_noduplicate.size(),"\n");
...
void Triangle2CFmeshFreez::storeCFmeshData()
{
  unsigned BND=0;
  int ip;
  vector <unsigned> np(2);
...
void  Triangle2CFmeshFreez::resizeConnectivityArray()
{
...
void Triangle2CFmeshFreez::storeConnectivity()
{
...
void Triangle2CFmeshFreez::storeField()
{
  unsigned start;

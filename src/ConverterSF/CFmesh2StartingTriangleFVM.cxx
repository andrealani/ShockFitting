...
#include <stdio.h>
#include <iomanip>
#include "ConverterSF/CFmesh2StartingTriangleFVM.hh"
...
ObjectProvider<CFmesh2StartingTriangleFVM, Converter>
CFmesh2StartingTriangleFVMProv("CFmesh2StartingTriangleFVM");

//----------------------------------------------------------------------------//

CFmesh2StartingTriangleFVM::CFmesh2StartingTriangleFVM(const std::string& objectName) :
...
CFmesh2StartingTriangleFVM::~CFmesh2StartingTriangleFVM()
{
}

//----------------------------------------------------------------------------//

void CFmesh2StartingTriangleFVM::setup()
{
  LogToScreen(VERBOSE, "CFmesh2StartingTriangleFVM::setup() => start\n");

  m_prim2param.ptr()->setup();

  LogToScreen(VERBOSE, "CFmesh2StartingTriangleFVM::setup() => end\n");
}

//----------------------------------------------------------------------------//

void CFmesh2StartingTriangleFVM::unsetup()
{
  LogToScreen(VERBOSE, "CFmesh2StartingTriangleFVM::unsetup()\n");
...
void CFmesh2StartingTriangleFVM::configure(OptionMap& cmap, const std::string& prefix)
{
...
void CFmesh2StartingTriangleFVM::convert()
{
  LogToScreen (INFO, "CFmesh2StartingTriangleFVM::convert()\n");

  // read CFmesh format file
  LogToScreen(DEBUG_MIN, "CFmesh2StartingTriangleFVM::reading CFmesh format\n");
  readCFmeshFmt();
  ...
  LogToScreen(DEBUG_MIN, "CFmesh2StartingTriangleFVM::writing Triangle format\n");
  writeTriangleFmt();
}

//----------------------------------------------------------------------------//

void CFmesh2StartingTriangleFVM::readCFmeshFmt()
{
  // dummy variables
...
void CFmesh2StartingTriangleFVM::setNodcod()
{
  int IPOIN, help;
...
void CFmesh2StartingTriangleFVM::resizeVectors()
{
...
void CFmesh2StartingTriangleFVM::writeTriangleFmt()
{

...
#ifndef ShockFitting_CFmesh2TriangleFVM_hh
#define ShockFitting_CFmesh2TriangleFVM_hh
...
/// This class defines a CFmesh2TriangleFVM, whose task is to make conversion
/// from CFmesh format to Triangle mesh generator format for
/// Finite Volume Method

class CFmesh2TriangleFVM : public Converter {
public:

  /// Constructor
  /// @param objectName the concrete class name
  CFmesh2TriangleFVM(const std::string& objectName);

  /// Destructor
  virtual ~CFmesh2TriangleFVM();
...
#endif // ShockFitting_CFmesh2TriangleFVM_hh

...
#ifndef ShockFitting_Triangle2CFmeshFVM_hh
#define ShockFitting_Triangle2CFmeshFVM_hh
...
/// This class defines Triangle2CFmeshFVM, whose task is to make conversion
/// from Triangle mesh generator format to CFmesh files format for the Finite
/// Volume Method case.
...
class Triangle2CFmeshFVM : public Converter {
public:

  /// Constructor
  /// @param objectName the concrete class name
  Triangle2CFmeshFVM(const std::string& objectName);

  /// Destructor
  virtual ~Triangle2CFmeshFVM();
...
private: // helper functions
  ...
  std::string getClassName() { return "Triangle2CFmeshFVM"; }
...
#endif // ShockFitting_Triangle2CFmeshFVM_hh

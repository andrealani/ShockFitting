...
#include <stdio.h>
#include <iomanip>
#include "ConverterSF/Tecplot2Triangle.hh"
...
ObjectProvider<Tecplot2Triangle, Converter>
Tecplot2TriangleProv("Tecplot2Triangle");

//----------------------------------------------------------------------------//

Tecplot2Triangle::Tecplot2Triangle(const std::string& objectName) :
...
Tecplot2Triangle::~Tecplot2Triangle()
{
}

//----------------------------------------------------------------------------//

void Tecplot2Triangle::setup()
{
  LogToScreen(VERBOSE, "Tecplot2Triangle::setup() => start\n");

  m_prim2param.ptr()->setup();

  LogToScreen(VERBOSE, "Tecplot2Triangle::setup() => end\n");
}

//----------------------------------------------------------------------------//

void Tecplot2Triangle::unsetup()
{
  LogToScreen(VERBOSE, "Tecplot2Triangle::unsetup()\n");
...
void Tecplot2Triangle::configure(OptionMap& cmap, const std::string& prefix)
{
...
void Tecplot2Triangle::convert()
{
  LogToScreen (INFO, "Tecplot2Triangle::convert()\n");

  setMeshData();
  setPhysicsData();

  // read Tecplot format file
  LogToScreen(DEBUG_MIN, "Tecplot2Triangle::reading Tecplot format\n");
  readTecplotFmt();
  ...
  if (MeshData::getInstance().getVersion()=="original")
  {
   ...
   LogToScreen(DEBUG_MIN, "Tecplot2Triangle::writing Triangle format\n");
   writeTriangleFmt(); 
  }
...
void Tecplot2Triangle::readTecplotFmt()
{
  // dummy variables
...
void Tecplot2Triangle::resizeVectors()
{
...
void Tecplot2Triangle::setNodcod()
{
  int IPOIN, help;
...
void Tecplot2Triangle::countnbBoundaryNodes()
{
  // write new nodcode values on the vector of the shocked mesh
  // in the fortran version this new vector is referred to index 1 (NODCOD(1))
  // here it is pushed back to the nodcod of the background mesh
...
void Tecplot2Triangle::writeTriangleFmt()
{
...
void Tecplot2Triangle::freeArray()
{
...
void Tecplot2Triangle::setMeshData()
{
...
void Tecplot2Triangle::setPhysicsData()
{

...
#ifndef ShockFitting_TecplotFVM2StartingTriangle_hh
#define ShockFitting_TecplotFVM2StartingTriangle_hh
...
/// This class defines a TecplotFVM2StartingTriangle, whose task is to make
...
/// This class differs from the TecplotFVM2StartingTriangle one because 
/// the elements nodes are read from the .CFmesh file beacuse COOLFluiD
/// applies an algorithm that changes the elements ID inside the Tecplot file
/// This class differs from the TecplotFVM2Triangle one because the
/// arrays do not belong to the MeshData and PhysicsData pattern 

class TecplotFVM2StartingTriangle  : public Converter {
public:

  /// Constructor
  /// @param objectName the concrete class name
  TecplotFVM2StartingTriangle(const std::string& objectName);

  /// Destructor
  virtual ~TecplotFVM2StartingTriangle();
...
private: // helper functions
  ...
  std::string getClassName() { return "TecplotFVM2StartingTriangle"; }
...
#endif // ShockFitting_TecplotFVM2StartingTriangle_hh
